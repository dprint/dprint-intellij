...
fun errorLogWithConsole(message: String, project: Project, logger: Logger) {
    errorLogWithConsole(message, null, project, logger)
}

fun errorLogWithConsole(message: String, throwable: Throwable?, project: Project, logger: Logger) {
    // Always use info for system level logging as it throws notifications into the UI
